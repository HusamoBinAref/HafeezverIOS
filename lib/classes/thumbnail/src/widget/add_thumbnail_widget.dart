  ...
  Widget _footer(ThumbnailState state) {
    ...
    return ButtonBar(
      children: <Widget>[
        ...
        FlatButton(
          child: Text(media != null && media.thumbnailUrl != null ? "SAVE" : "NEXT",
          ...
          onPressed: () {
            if (media == null ||
              ...
              BlocProvider.of<ThumbnailBloc>(context).add(AddUrl(url: _txtController.text));
            } else {
  ...
  Widget _previewSection(ThumbnailState state) {
    ...
    return AnimatedSwitcher(
      ...
      child: state is LoadingMedia ||
              ...
              state is LoadedMedia && (media == null || media.thumbnailUrl == null)
          ? _loader(state)
          ...
          child: Column(
            ...
            children: <Widget>[
              Opacity(
                ...
                child: AspectRatio(
                  aspectRatio: 16 / 9,
                  child: media.thumbnailUrl == null || media.thumbnailUrl == ""
                      ? Center(
                          child: Text(
                            widget.errorText,
